...
class Tilemap2 : public base::RefCounted<Tilemap2>,
 ...
 private:
  ...
  void CreateTileAtlasInternal(bgfx::Encoder* encoder,
                               bgfx::ViewId* render_view);
  ...
  void DrawZLayerInternal(CompositeTargetInfo* target_info);
  ...
  std::vector<renderer::GeometryVertexLayout::Data> above_vertices_;
